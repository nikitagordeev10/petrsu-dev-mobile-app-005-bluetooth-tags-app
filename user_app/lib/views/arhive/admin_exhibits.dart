...
// import 'package:museum_app/views/user/userCheckQuestionScreen.dart';
//
// class adminExibitScreen1 extends StatefulWidget {
//   final List<int> foundExhibitsList;
//   final int questId;
//   const adminExibitScreen1({Key? key, required this.foundExhibitsList, required this.questId});
//
//   @override
//   _adminExibitScreen1State createState() => _adminExibitScreen1State(foundExhibitsList: foundExhibitsList, questId: questId);
// }
//
// class _adminExibitScreen1State extends State<adminExibitScreen1> {
//   List<int> foundExhibitsList;
//   int questId;
//   List<bool> _isCardCorrect = [];
//   List<List<dynamic>> _exhibitsInfoList = [];
//   _adminExibitScreen1State({required this.foundExhibitsList, required this.questId});
//
