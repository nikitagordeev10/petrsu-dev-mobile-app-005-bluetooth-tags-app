...
import 'adminExibitScreen.dart'; // Импорт файла с экраном экспонатов
import 'adminTagsScreen.dart'; // Импорт файла с экраном экспонатов

class AdminExibitScreen extends StatefulWidget {
  const AdminExibitScreen({Key? key}) : super(key: key);
